...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <h5 class="card-header bg-transparent border-bottom text-uppercase">konfirmasi Pembayaran</h5>
            <div class="card-body">
                ...
                <a href="include/cetak_bukti_pembayaran_kegiatan.php?id=' . $id_detail . '" ></a>
            </li>';
                                    }
                                } else {
