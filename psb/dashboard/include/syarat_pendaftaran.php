...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Syarat Pendaftaran</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Berikut adalah syarat pendaftaran siswa baru yang harus dipenuhi :</h4>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                if ($upload_akte != "" && $upload_kartu_keluarga != "") {
                                    ...
                                    if ($daftar['status_pendaftaran'] == 1) {
                                        ...
                                        echo '<font color="#2ecc71">Fotocopy Akte kelahiran dan kartu keluarga 2 lembar<i class="fa fa-check"></i></font> <a href="index.php?page=5" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil-alt"></i></a>';
                                    }
                                } else {
                            ...
                            <li>
                                ...
                                if ($foto_anak != "" && $foto_keluarga != "") {
                                    ...
                                    if ($daftar['status_pendaftaran'] == 1) {
                                        echo '<font color="#2ecc71">Ijazah dan SKHUN<i class="fa fa-check"></i></font>';
                                    } else if ($daftar['status_pendaftaran'] >= 2) {
                                        echo '<font color="#2ecc71">Ijazah dan SKHUN<i class="fa fa-check"></i></font>';
                                    } else {
                                        echo '<font color="#2ecc71">Ijazah dan SKHUN<i class="fa fa-check"></i></font> <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil-alt"></i></a>';
                                    }
                                } else {
                                    echo 'Ijazah dan SKHUN <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-upload"></i></a>';
                                }
