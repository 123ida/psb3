...
$pdf->Cell(100, 10, 'List Pendaftaran SMA NEGERI 1 PANCURBATU', 2, 2, 'C');
$pdf->Ln();
...
$pdf->SetWidths(array(10, 40, 50, 20, 20, 30));

while ($rows = mysqli_fetch_array($exec)) {
  $pdf->Row(array(++$no, $rows['nama'], $rows['email'], $rows['jenis_kelamin'], $rows['kelas'], $rows['tanggal_daftar']));
}
